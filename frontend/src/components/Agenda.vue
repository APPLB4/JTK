...
<section class="text-gray-600 body-font">
        <div class="container px-5 pt-10 mx-auto mb-10">
          ...
          <div class="flex flex-wrap -m-4"
           ...
           :key="tag">
            <router-link :to="{ name: 'ArticleRead', params: { id:index, judul:'Agenda', image:article[index].kegiatan_medias[0].media.url, deskripsi:tag.deskripsi  }}">
           
              <div class="h-full rounded shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
                
                <img class="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100"  v-bind:src="article[index].kegiatan_medias[0].media.url">
                <div class="p-6">

                  <h1 class="title-font text-lg font-medium text-gray-600 mb-3">{{tag.judul}}</h1>
